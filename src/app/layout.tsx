  ...
  return (
    <html lang="en" suppressHydrationWarning={true}>
      <body className={cn(inter.className, "antialiased")}>
        <div id="loader" className="fixed inset-0 bg-gradient-to-br from-[rgba(17,24,39,0.8)] via-[rgba(31,41,55,0.8)] to-[rgba(0,0,0,0.8)] backdrop-blur-lg flex flex-col items-center justify-center z-[7000] transition-opacity duration-500 bg-opacity-30">
